    ...
    <section className="px-4 sm:px-6 lg:px-12">
      <ParallaxBackground variant="cta" intensity="low" className="mx-auto mt-20 w-full max-w-6xl rounded-4xl">
        <motion.div
          ...
          className="relative overflow-hidden rounded-4xl bg-gradient-to-r from-brand-600 via-brand-600 to-brand-700 text-white shadow-brand"
        >
          ...
          <div className="relative flex flex-col gap-6 px-6 py-10 sm:px-8 md:flex-row md:items-center md:justify-between md:px-12 md:py-12">
